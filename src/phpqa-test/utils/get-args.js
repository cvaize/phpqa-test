...
let accessTools = Object.values(config.PHPQA.TOOLS)
...
const commandsArgs = {
    join() {
        const params = {}
        // if (!params.filepath) {
        //     throw new Error('Укажите путь к файлу, в который нужно влить данные.');
        // }
        //
        ...
        const parsedParams = ArgParser.parse(process.argv.slice(3), {
            args: [{
